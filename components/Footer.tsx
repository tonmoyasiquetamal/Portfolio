...
export default function Footer() {
  return (
    <section className="px-4 max-w-6xl mx-auto py-4 mt-14">
      ...
      <div className="flex flex-wrap p-8 bg-white rounded-3xl items-center justify-center gap-5">
        <Link href="https://www.linkedin.com/in/tonmoy-asique-tamal/" target="_blank">
          <svg
            className="w-16 h-16"
        ...
        <Link href="https://github.com/tonmoyasiquetamal" target="_blank">
          <svg
            className="w-16 h-16"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 128 128"
